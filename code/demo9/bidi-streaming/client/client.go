...
import (
	...
	"context"
	"fmt"
	"github.com/lwenjim/study-golang/code/demo9/bidi-streaming/service"
...
func setupChat(r io.Reader, w io.Writer, c service.UsersClient) error {
	stream, err := c.GetHep(context.Background())
	if err != nil {
		return err
	}
	for {
